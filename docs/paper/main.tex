...
\begin{figure}[t]
    ...
    \begin{subfigure}{0.32\linewidth}
        ...
        \caption{Radius of gyration statistics.}
        \label{fig:phase1_rg}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../results/phase1/pca_projection.png}
        \caption{PCA projection of conformations.}
        \label{fig:phase1_pca}
    \end{subfigure}
    \caption{Quality-control diagnostics from the validation script showing that the molecular dynamics ensemble spans diverse conformations prior to training.}
    \label{fig:phase1_qc}
\end{figure}
